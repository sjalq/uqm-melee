...
suite =
    describe "Linked rooms and economical authoritative delivery"
        ...
        , test "combat is capped at ten deliveries and preview at two per second" <|
            \() ->
                let
                    watching =
                ...
                in
                Expect.all [ \_ -> Expect.atMost 10 (count "w"), \_ -> Expect.atLeast 7 (count "w"), \_ -> Expect.equal 2 (count "l") ] ()
