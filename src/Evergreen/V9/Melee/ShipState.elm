module Evergreen.V9.Melee.ShipState exposing (..)
...
type alias CombatantCore =
    { element : Evergreen.V9.Melee.Id.ElementId
    , characteristics : Evergreen.V9.Melee.Ship.Characteristics
    , energy : Int
    , maxEnergy : Int
    , maxCrew : Int
    ...
    , input : Evergreen.V9.Melee.Input.BattleInput
    , shieldTicks : Int
    , confusedTicks : Int
    , chargeTicks : Int
    , cloaked : Bool
    , oldInput : Evergreen.V9.Melee.Input.BattleInput
    , flags : MotionFlags
    }
...
type AndrosynthExtra
    = Guardian
    | Blazer
        { guardian : Evergreen.V9.Melee.Ship.Characteristics
        }


type ArilouExtra
    = Present
    | Teleporting Evergreen.V9.Melee.Units.Wait
...
type alias MelnormeExtra =
    { pump : PumpLevel
    , levelCounter : Evergreen.V9.Melee.Units.Wait
    }
...
type alias MmrnmhrmExtra =
    { form : MmrnmhrmForm
    , otherWing : Evergreen.V9.Melee.Ship.Characteristics
    }


type alias OrzExtra =
    { turretFacing : Evergreen.V9.Melee.Units.Facing
    , turretWait : Evergreen.V9.Melee.Units.Wait
    }


type PkunkExtra
    = Flying
    | Phoenix Evergreen.V9.Melee.Id.ElementId
...
type SupoxExtra
    = ForwardOnly
    | Strafing Evergreen.V9.Melee.Input.Turn
...
type alias UmgahExtra =
    { prevFacing : Evergreen.V9.Melee.Units.Facing
    }
