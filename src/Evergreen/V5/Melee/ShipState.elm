module Evergreen.V5.Melee.ShipState exposing (..)
...
type alias CombatantCore =
    { element : Evergreen.V5.Melee.Id.ElementId
    , characteristics : Evergreen.V5.Melee.Ship.Characteristics
    , energy : Int
    , maxEnergy : Int
    , maxCrew : Int
    , weaponWait : Evergreen.V5.Melee.Units.Wait
    , specialWait : Evergreen.V5.Melee.Units.Wait
    , energyWait : Evergreen.V5.Melee.Units.Wait
    , facing : Evergreen.V5.Melee.Units.Facing
    , input : Evergreen.V5.Melee.Input.BattleInput
    , shieldTicks : Int
    , confusedTicks : Int
    , chargeTicks : Int
    , cloaked : Bool
    , oldInput : Evergreen.V5.Melee.Input.BattleInput
    , flags : MotionFlags
    }
...
type AndrosynthExtra
    = Guardian
    | Blazer
        { guardian : Evergreen.V5.Melee.Ship.Characteristics
        }


type ArilouExtra
    = Present
    | Teleporting Evergreen.V5.Melee.Units.Wait
...
type alias MelnormeExtra =
    { pump : PumpLevel
    , levelCounter : Evergreen.V5.Melee.Units.Wait
    }
...
type alias MmrnmhrmExtra =
    { form : MmrnmhrmForm
    , otherWing : Evergreen.V5.Melee.Ship.Characteristics
    }


type alias OrzExtra =
    { turretFacing : Evergreen.V5.Melee.Units.Facing
    , turretWait : Evergreen.V5.Melee.Units.Wait
    }


type PkunkExtra
    = Flying
    | Phoenix Evergreen.V5.Melee.Id.ElementId
...
type SupoxExtra
    = ForwardOnly
    | Strafing Evergreen.V5.Melee.Input.Turn
...
type alias UmgahExtra =
    { prevFacing : Evergreen.V5.Melee.Units.Facing
    }
