...
import Evergreen.V2.Melee.Keys
...
type alias AdminPageModel =
    { logs : List Evergreen.V2.Logger.LogEntry
...
type alias FrontendModel =
    ...
    , loginModalOpen : Bool
    , melee : Evergreen.V2.Melee.Room.Client
    , player : Maybe Evergreen.V2.Melee.Ranking.Profile
    , playerName : String
    , searching : Bool
    , meleeNow : Int
    , creatingRoom : Bool
    , location : Evergreen.V2.Melee.Location.Location
    , arenaPreview : Maybe Evergreen.V2.Melee.Preview.Preview
    , showLocalGame : Bool
    , watchableGames : List Evergreen.V2.Melee.Room.GameListing
    , availableRooms : Maybe (List Evergreen.V2.Melee.Room.Listing)
    , roomCode : String
    , meleeHeld : Evergreen.V2.Melee.Keys.Held
...
type alias BackendModel =
    { logState : Evergreen.V2.Logger.LogState
    ...
    , melee : Evergreen.V2.Melee.Room.Host
    }
...
type ToBackend
    ...
    | MeleeToBackend Evergreen.V2.Melee.Room.ToHost
...
type FrontendMsg
    ...
    | MeleeLocal Evergreen.V2.Melee.Room.LocalMsg
    | GameMsg Evergreen.V2.Melee.Local.Msg
    | MeleeFrame Float
    | Online Evergreen.V2.Melee.Room.ToHost
    | RoomCodeChanged String
    | ShowLocalGame Bool
    | NavigateMelee Evergreen.V2.Melee.Location.Location
...
type BackendMsg
    ...
    | GotLogTime Evergreen.V2.Logger.Msg
...
type ToFrontend
    = A0 String
    | Admin_Logs_ToFrontend (List Evergreen.V2.Logger.LogEntry)
    ...
    | MeleeToFrontend Evergreen.V2.Melee.Room.ToSeat
