...
import Evergreen.V12.Melee.Jev
...
type alias FrontendModel =
    ...
    , loginModalOpen : Bool
    , melee : Evergreen.V12.Melee.Room.Client
    , player : Maybe Evergreen.V12.Melee.Ranking.Profile
    , playerName : String
    , searching : Bool
    , meleeVisible : Bool
    , telemetry : Evergreen.V12.Melee.Telemetry.Client
    , telemetryReply : Maybe Evergreen.V12.Melee.Telemetry.Snapshot
    , meleeNow : Int
    , creatingRoom : Bool
    , location : Evergreen.V12.Melee.Location.Location
    , arenaPreview : Maybe Evergreen.V12.Melee.Local.Model
    , showLocalGame : Bool
    , watchableGames : List Evergreen.V12.Melee.Room.GameListing
    , availableRooms : Maybe (List Evergreen.V12.Melee.Room.Listing)
    , roomCode : String
    , meleeHeld : Evergreen.V12.Melee.Keys.Held
    , game : Evergreen.V12.Melee.Local.Model
    , jev : Evergreen.V12.Melee.Jev.Client
    , pickCell :
        { bottom : Evergreen.V12.Melee.Picker.Cell
        , top : Evergreen.V12.Melee.Picker.Cell
        }
    }
...
type alias BackendModel =
    ...
    , counters : Evergreen.V12.Melee.Telemetry.Counters
    , workload : Evergreen.V12.Melee.Telemetry.Snapshot
    , melee : Evergreen.V12.Melee.Room.Host
    }
...
type ToBackend
    ...
    | Probe Int Bool
    | MeleeToBackend Evergreen.V12.Melee.Room.ToHost
...
type FrontendMsg
    ...
    | MeleeLocal Evergreen.V12.Melee.Room.LocalMsg
    | GameMsg Evergreen.V12.Melee.Local.Msg
    | MeleeFrame Float
    | Online Evergreen.V12.Melee.Room.ToHost
    | RoomCodeChanged String
    | ShowLocalGame Bool
    | NavigateMelee Evergreen.V12.Melee.Location.Location
    | PlayerNameChanged String
    | MeleeBrowser Evergreen.V12.Melee.Menu.Event
...
type ToFrontend
    ...
    | ProbeReply Int (Maybe Evergreen.V12.Melee.Telemetry.Snapshot)
    | MeleeToFrontend Evergreen.V12.Melee.Room.ToSeat
