module Evergreen.V12.Melee.ShipState exposing (..)
...
type alias CombatantCore =
    { element : Evergreen.V12.Melee.Id.ElementId
    , characteristics : Evergreen.V12.Melee.Ship.Characteristics
    , energy : Int
    , maxEnergy : Int
    , maxCrew : Int
    , weaponWait : Evergreen.V12.Melee.Units.Wait
    , specialWait : Evergreen.V12.Melee.Units.Wait
    , energyWait : Evergreen.V12.Melee.Units.Wait
    , facing : Evergreen.V12.Melee.Units.Facing
    , input : Evergreen.V12.Melee.Input.BattleInput
    , shieldTicks : Int
    , confusedTicks : Int
    , chargeTicks : Int
    , cloaked : Bool
    , oldInput : Evergreen.V12.Melee.Input.BattleInput
    , flags : MotionFlags
    }
...
type AndrosynthExtra
    = Guardian
    | Blazer
        { guardian : Evergreen.V12.Melee.Ship.Characteristics
        }


type ArilouExtra
    = Present
    | Teleporting Evergreen.V12.Melee.Units.Wait
...
type alias MelnormeExtra =
    { pump : PumpLevel
    , levelCounter : Evergreen.V12.Melee.Units.Wait
    }
...
type alias MmrnmhrmExtra =
    { form : MmrnmhrmForm
    , otherWing : Evergreen.V12.Melee.Ship.Characteristics
    }


type alias OrzExtra =
    { turretFacing : Evergreen.V12.Melee.Units.Facing
    , turretWait : Evergreen.V12.Melee.Units.Wait
    }


type PkunkExtra
    = Flying
    | Phoenix Evergreen.V12.Melee.Id.ElementId
...
type SupoxExtra
    = ForwardOnly
    | Strafing Evergreen.V12.Melee.Input.Turn
...
type alias UmgahExtra =
    { prevFacing : Evergreen.V12.Melee.Units.Facing
    }
