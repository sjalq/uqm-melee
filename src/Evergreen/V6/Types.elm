...
import Evergreen.V6.Melee.Menu
...
type alias AdminPageModel =
    { logs : List Evergreen.V6.Logger.LogEntry
...
type LoginState
    ...
    | NotLogged Bool
    | LoginTokenSent
    | LoggedIn Evergreen.V6.Auth.Common.UserInfo
...
type alias FrontendModel =
    ...
    , loginModalOpen : Bool
    , melee : Evergreen.V6.Melee.Room.Client
    , player : Maybe Evergreen.V6.Melee.Ranking.Profile
    , playerName : String
    , searching : Bool
    , meleeVisible : Bool
    , telemetry : Evergreen.V6.Melee.Telemetry.Client
    , telemetryReply : Maybe Evergreen.V6.Melee.Telemetry.Snapshot
    , meleeNow : Int
    , creatingRoom : Bool
    , location : Evergreen.V6.Melee.Location.Location
    , arenaPreview : Maybe Evergreen.V6.Melee.Local.Model
    , showLocalGame : Bool
    , watchableGames : List Evergreen.V6.Melee.Room.GameListing
    , availableRooms : Maybe (List Evergreen.V6.Melee.Room.Listing)
    , roomCode : String
    , meleeHeld : Evergreen.V6.Melee.Keys.Held
...
type alias BackendModel =
    { logState : Evergreen.V6.Logger.LogState
    ...
    , counters : Evergreen.V6.Melee.Telemetry.Counters
    , workload : Evergreen.V6.Melee.Telemetry.Snapshot
    , melee : Evergreen.V6.Melee.Room.Host
    }
...
type ToBackend
    ...
    | Probe Int Bool
    | MeleeToBackend Evergreen.V6.Melee.Room.ToHost
...
type FrontendMsg
    ...
    | MeleeLocal Evergreen.V6.Melee.Room.LocalMsg
    | GameMsg Evergreen.V6.Melee.Local.Msg
    | MeleeFrame Float
    | Online Evergreen.V6.Melee.Room.ToHost
    | RoomCodeChanged String
    | ShowLocalGame Bool
    | NavigateMelee Evergreen.V6.Melee.Location.Location
    | PlayerNameChanged String
    | MeleeBrowser Evergreen.V6.Melee.Menu.Event
...
type BackendMsg
    ...
    | GotLogTime Evergreen.V6.Logger.Msg
...
type ToFrontend
    = A0 String
    | Admin_Logs_ToFrontend (List Evergreen.V6.Logger.LogEntry)
    ...
    | ProbeReply Int (Maybe Evergreen.V6.Melee.Telemetry.Snapshot)
    | MeleeToFrontend Evergreen.V6.Melee.Room.ToSeat
