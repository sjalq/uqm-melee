...
N_WEIGHTS = 1133
ALL_SHIPS = [
    "Androsynth", "Arilou", "Chenjesu", "Chmmr", "Druuge", "Earthling",
    "Ilwrath", "KohrAh", "Melnorme", "Mmrnmhrm", "Mycon", "Orz", "Pkunk",
    "Shofixti", "Slylandro", "Spathi", "Supox", "Syreen", "Thraddash",
...
def main():
    ...
    parser.add_argument("--elm-worker", type=Path, default=ROOT / "scripts/oracle/neat-eval.js")
    ...
    elm_sha256 = hashlib.sha256((args.elm_worker.parent / "neat-eval-elm.js").read_bytes()).hexdigest()
    workers = []
